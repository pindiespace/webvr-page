...
function createRenderTarget(renderer) {
  console.log("IN RENDERTARGET, SETTING SIZE TO WIDTH:" + renderer.context.canvas.width + " HEIGHT:" + renderer.context.canvas.height) //////////////////////////////////
...
CardboardDistorter.prototype.patch = function() {
  ...
  this.renderer.setSize = function(width, height) {
    console.log("IN DISTORTER, SETTING SIZE TO WIDTH:" + width + " HEIGHT:" + height) //////////////////////////////////
